...
use hytale_core::hytale_server_config::ConnectionTimeouts;
use crate::auth::server_auth_manager::ServerAuthManager;
use crate::connection_manager::{Connection, ConnectionContext};
use crate::handlers::initial_handler::InitialPacketHandler;
use crate::utils::client_verifier::ClientVerifier;
use crate::utils::rate_limiter::RateLimiter;
use crate::utils::stage_timer::StageTimer;
...
impl ServerNetworkManager {
    pub async fn init() {
        ...
        let (endpoint, cert) = Self::create_endpoint().await
