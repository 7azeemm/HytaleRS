use std::sync::Arc;
use log::info;
use assets::common::common_asset_registry::COMMON_ASSET_REGISTRY;
use hytale_core::hytale_server::HytaleServer;
use hytale_core::hytale_server_config::WORLD_HEIGHT;
...
use crate::handlers::handshake_handler::PlayerAuthentication;
